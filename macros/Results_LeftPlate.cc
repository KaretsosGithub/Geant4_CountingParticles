...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     ...
     can be detected inside the Left Plate. It also draws
...
const char* kBranchName = "PDG_encoding_Left";
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------

int Results_LeftPlate() {
    ...
    vector<int> left_plate_particles = read_branch(particle_tree, kBranchName);

    // Count the particles
    unordered_map<int, int> counts;
    count_particles(left_plate_particles, counts);

    // Print the results
    printLine();
    cout << "Total number of primary particles: 1000000" << endl;
    cout << "Total number of unique particles/nuclei detected inside the Left Plate: " << left_plate_particles.size() << endl;
    printLine();
    ...
    FillHistograms(left_plate_particles, histograms);
